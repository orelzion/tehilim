...
public class ZmanimFormatter {
     ...
     *
     * @param format int The formatting style to use. Using ZmanimFormatter.SEXAGESIMAL_SECONDS_FORMAT will format the time
     ...
     * @param calendar the {@link java.util.Calendar Calendar} used to help format based on the Calendar's DST and other
     *                 settings.
