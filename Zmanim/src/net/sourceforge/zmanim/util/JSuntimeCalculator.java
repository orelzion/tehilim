...
public class JSuntimeCalculator extends AstronomicalCalculator {
    ...
    /**
     * @throws ZmanimException if the year entered == 2000. This calculator can't properly deal with the year 2000. It can properly
     ...
     * @param zenithDistance one of Sun.SUNRISE_SUNSET_ZENITH_DISTANCE, Sun.CIVIL_TWILIGHT_ZENITH_DISTANCE,
     ...
     *
     * @param centuries Number of Julian centuries since J2000.0
