...
public class NOAACalculator extends AstronomicalCalculator {
     ...
     *
     * @param calendar The Java Calendar
     ...
     *
     * @param julianCenturies the number of Julian centuries since J2000.0
     ...
     *
     * @param julianCenturies the number of Julian centuries since J2000.0
     * @param sun             's declination in degrees
     */
     ...
     * latitude.
     *
     * @param lat      , the latitude of observer in degrees
     * @param solarDec the declination angle of sun in degrees
