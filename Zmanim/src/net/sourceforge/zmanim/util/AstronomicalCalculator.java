...
public abstract class AstronomicalCalculator implements Cloneable {
     ...
     * @param zenith      the azimuth below the vertical zenith of 90 degrees. for sunrise typically the {@link #adjustZenith
     ...
     * @param calendar    Used to calculate day of year.
     * @param geoLocation The location information used for astronomical calculating sun times.
     * @param zenith      the azimuth below the vertical zenith of 90&deg;. For sunset typically the {@link #adjustZenith
     *                    zenith} used for the calculation uses geometric zenith of 90&deg; and {@link #adjustZenith adjusts}
     *                    this slightly to account for solar refraction and the sun's radius. Another example would be
     ...
     * increased accuracy.
     *
     * @param refraction The refraction in arc minutes.
     * @see #getRefraction()
     */
     ...
     *
     * @param solarRadius The sun's radius in arc minutes.
     * @see #getSolarRadius()
     */
