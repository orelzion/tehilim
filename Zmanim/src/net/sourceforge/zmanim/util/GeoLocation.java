...
public class GeoLocation implements Cloneable {
     ...
     * @param latitude  the latitude in a double format such as 40.095965 for Lakewood, NJ <br/>
     *                  <b>Note: </b> For latitudes south of the equator, a negative value should be used.
     * @param longitude double the longitude in a double format such as -74.222130 for Lakewood, NJ. <br/>
     ...
     *                  <b>Note: </b> For longitudes east of the <a href="http://en.wikipedia.org/wiki/Prime_Meridian">Prime
     *                  Meridian </a> (Greenwich), a negative value should be used.
     * @param elevation the elevation above sea level in Meters. Elevation is not used in most algorithms used for calculating
     *                  sunrise and set.
     * @param timeZone  the <code>TimeZone</code> for the location.
     */
     ...
     *
     * @param latitude The degrees of latitude to set. The values should be between -90&deg; and 90&deg;. An
     ...
     *
     * @param degrees   The degrees of latitude to set between -90 and 90. An IllegalArgumentException will be thrown if the
     ...
     * @param direction N for north and S for south. An IllegalArgumentException will be thrown if the value is not S or N.
     */
     ...
     *
     * @param longitude The degrees of longitude to set in a double format between -180&deg; and 180&deg;. An
     ...
     *
     * @param degrees   The degrees of longitude to set between -180 and 180. An IllegalArgumentException will be thrown if
     ...
     * @param minutes   <a href="http://en.wikipedia.org/wiki/Minute_of_arc#Cartography">minutes of arc</a>
     * @param seconds   <a href="http://en.wikipedia.org/wiki/Minute_of_arc#Cartography">seconds of arc</a>
     * @param direction E for east of the Prime Meridian or W for west of it. An IllegalArgumentException will be thrown if
     ...
     *
     * @param location the destination location
     * @param formula  This formula calculates initial bearing ({@link #INITIAL_BEARING}), final bearing (
