...
public class JewishCalendar extends JewishDate {
    ...
    public static final int EREV_CHANUKAH = 20;
    ...
    public static final int YOM_CHOL = -1;
     ...
     *                         or {@link #KISLEV} in a year that {@link #isKislevShort()}), the 29th (last valid date of the month)
     *                         will be set
     * @param inIsrael         whether in Israel. This affects Yom Tov and Parsha calculations
     */
    ...
    public boolean isAseret() {
        if (getJewishMonth() == TISHREI && getJewishDayOfMonth() <= 10)
            return true;
    ...
    public boolean isYomTov() {
        ...
        if (holidayIndex == SHAVUOS || holidayIndex == PESACH || holidayIndex == SUCCOS || holidayIndex == ROSH_HASHANA || holidayIndex == YOM_KIPPUR) {
            return true;
        }
        return false;
    }
    ...
    public boolean isCholHamoed() {
        int holidayIndex = getYomTovIndex();
        return holidayIndex == JewishCalendar.CHOL_HAMOED_PESACH || holidayIndex == JewishCalendar.CHOL_HAMOED_SUCCOS || holidayIndex == JewishCalendar.HOSHANA_RABBA;
    }
    ...
    /**
     * Returns whether or not this is Omer now
     *
     * @return True - if Omer, false otherwise
     */
