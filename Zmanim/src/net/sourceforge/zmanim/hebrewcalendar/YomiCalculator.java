...
public class YomiCalculator {
     ...
     *
     * @param calendar the calendar date for calculation
     * @return the {@link Daf}.
     * @throws IllegalArgumentException if the date is prior to the September 11, 1923 start date of the first Daf Yomi cycle
     */
