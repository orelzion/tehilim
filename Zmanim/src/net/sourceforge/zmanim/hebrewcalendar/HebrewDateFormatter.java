...
public class HebrewDateFormatter {
    ...
    private String[] transliteratedHolidays = {"Erev Pesach", "Pesach", "Chol Hamoed Pesach", "Pesach Sheni",
            ...
            "Yom HaShoah", "Yom Hazikaron", "Yom Ha'atzmaut", "Yom Yerushalayim", "Lag Ba'Omer"};
     ...
     * "Purim Katan", "Rosh Chodesh", "Yom HaShoah", "Yom Hazikaron", "Yom Ha'atzmaut", "Yom Yerushalayim", "Lag Ba'Omer"
     ...
     *
     * @param transliteratedHolidays the transliteratedHolidays to set. Ensure that the sequence exactly matches the list returned by the
     *                               defaulyt
     */
     ...
     *
     * @param hebrewFormat the hebrewFormat to set
     * @see #isHebrewFormat()
     * @see #format(JewishDate)
     * @see #formatDayOfWeek(JewishDate)
     * @see #formatMonth(JewishDate)
     ...
     *
     * @param hebrewOmerPrefix the hebrewOmerPrefix to set. You can use the Unicode &#92;u05DC to set it to &#x5DC;.
     ...
     *
     * @param transliteratedMonths an array of 14 month names such as { "Nissan", "Iyar", "Sivan", "Tamuz", "Av", "Elul", "Tishrei",
     ...
     * &#x5EA;&#x5E9;&#x5DA;.
     *
     * @param useGershGershayim set to false to omit the Geresh &#x5F3; and Gershayim &#x5F4; in formatting
     */
    ...
    /**
     * Formats the Jewish date. If the formatter is set to Hebrew it will return the day of month in Hebrew letters, if not
     * it will only return the number.
     *
     * @param jewishDate The Jewish date to be formatted
     * @return The formatted date
     */
    public String formatDayOfMonth(JewishDate jewishDate) {
        if (isHebrewFormat())
    ...
    public String formatYear(JewishDate jewishDate) {
        if (isHebrewFormat())
            return formatHebrewNumber(jewishDate.getJewishYear());
        else
     ...
     * </ul>
     *
     * @param number the number to be formatted. It will trow an IllegalArgumentException if the number is < 0 or > 9999.
