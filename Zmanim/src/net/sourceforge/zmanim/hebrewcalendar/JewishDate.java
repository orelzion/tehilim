...
public class JewishDate implements Comparable<JewishDate>, Cloneable {
     ...
     * @param month      the Gregorian month. Unlike the Java Calendar where January has the value of 0,This expects a 1 for
     *                   January
     ...
     *
     * @param year  the Jewish year
     * @param month the Jewish month the Jewish month, with the month numbers starting from Nisan. Use the JewishDate
     ...
     * @param chalakim   the chalakim/parts (for molad calculations). It will reject a chalakim < 0 or > 17. For larger numbers
     ...
     * @throws IllegalArgumentException if a A Jewish date earlier than 18 Teves, 3761 (1/1/1 Gregorian), a month < 1 or > 12 (or 13 on a
     ...
     *
     * @param year       the Gregorian year to validate. It will reject any year < 1.
     * @param month      the Gregorian month number to validate. It will enforce that the month is between 0 - 11 like a
     *                   {@link GregorianCalendar}, where {@link Calendar#JANUARY} has a value of 0.
     * @param dayOfMonth the day of the Gregorian month to validate. It will reject any value < 1, but will allow values > 31
     ...
     * @throws IllegalArgumentException if a year of < 1, a month < 0 or > 11 or a day of month < 1 is passed in
     ...
     * @param month      the Jewish month starting with Nisan. Nisan expects a value of 1 etc till Adar with a value of 12. For
     ...
     * @throws IllegalArgumentException if the {@link Calendar#ERA} is {@link GregorianCalendar#BC}
     */
     ...
     *
     * @param year       the Gregorian year
     * @param month      the Gregorian month. Like the Java Calendar, this class expects 0 for January
     * @param dayOfMonth the Gregorian day of month. If this is > the number of days in the month/year, the last valid date of
     ...
     *
     * @param year       the Jewish year. The year can't be negative
     * @param month      the Jewish month starting with Nisan. A value of 1 is expected for Nissan ... 12 for Adar and 13 for
     ...
     * @param chalakim   the chalakim/parts. Used for Molad calculations. The chalakim should not exceed 17. Minutes should be
     ...
     *
     * @param month the Gregorian month
     * @throws IllegalArgumentException if a month < 0 or > 11 is passed in
     */
     ...
     * @throws IllegalArgumentException if the day of month of < 1 is passed in
     */
     ...
     *
     * @param month the Jewish month from 1 to 12 (or 13 years in a leap year). The month count starts with 1 for Nisan
     *              and goes to 13 for Adar II
     * @throws IllegalArgumentException if a month < 1 or > 12 (or 13 on a leap year) is passed in
     */
     ...
     *
     * @param year the Jewish year
     * @throws IllegalArgumentException if a year of < 3761 is passed in. The same will happen if the year is 3761 and the month and day
     ...
     * @throws IllegalArgumentException if the day of month is < 1 or > 30 is passed in
     */
    ...
    /**
     * Returns a double value indicates the month in hebrew and day
     *
     * @return
     */
    public double toDouble_day_and_month() {
        String dayS;
        if (getJewishDayOfMonth() < 10)
            dayS = "0" + getJewishDayOfMonth();
        else
            dayS = "" + getJewishDayOfMonth();
        String temp = getJewishMonth() + "." + dayS;
    ...
    public Date toDate() {
        ...
        c.set(gregorianYear, gregorianMonth - 1, gregorianDayOfMonth);
